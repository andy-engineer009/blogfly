...
const validationSchema = Yup.object({
  name: Yup.string().trim().required("श्रेणी का नाम आवश्यक है"),
      ...
      <header className="flex flex-col gap-4 rounded-2xl border border-[var(--border-color)] bg-gradient-to-br from-[var(--surface)] via-[var(--surface)] to-[var(--card)] p-6 shadow-lg sm:flex-row sm:items-center sm:justify-between sm:p-8">
        <div className="flex items-center gap-4">
          <Link
            ...
            aria-label="श्रेणियों पर वापस जाएं"
          >
          ...
          <div>
            ...
            <h1 className="mt-1 text-2xl font-bold text-[var(--foreground)] sm:text-3xl">कैटेगरी संपादित करें</h1>
          </div>
        </div>
      </header>
        ...
        <form onSubmit={formik.handleSubmit} className="flex flex-col gap-8">
          ...
          <div className="space-y-3">
            ...
            <div className="relative">
              <input
                ...
                placeholder="उदाहरण: क्रिकेट, फिटनेस, समाचार..."
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              onBlur={formik.handleBlur}
              rows={4}
              placeholder="इस श्रेणी के बारे में संक्षिप्त विवरण..."
            ...
            />
            <p className="text-xs text-[var(--muted)]">कैटेगरी के बारे में संक्षिप्त जानकारी दें</p>
          </div>
